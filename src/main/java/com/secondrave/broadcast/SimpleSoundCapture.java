...
public class SimpleSoundCapture extends JPanel implements ActionListener {
    ...
    private TargetDataLine getTargetLine(AudioFormat format) throws LineUnavailableException {
        final TargetDataLine tdl = AudioSystem.getTargetDataLine(format, AudioSystem.getMixerInfo()[2]);
        return tdl;
    }
